...
(function () {
    for (var i = 0; i < questionData.length; i++) {
        ...
        items[i] = new QuestionStatement(item[0], item[1]);
    }
})()
...
function loadStatus() {
    currentIndex = eval(window.localStorage.getItem("currentIndex_questionStatement"))
    if (null == currentIndex) { currentIndex = 0; }
}

function saveStatus() {
    window.localStorage.setItem("currentIndex_questionStatement", currentIndex);
}
